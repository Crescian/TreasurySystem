...
<head>
    ...
    <title>Treasury System - Login</title>
...
<body class="font-sans antialiased dark:bg-black dark:text-black/50" style="overflow: hidden">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-black/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl" style="margin-top: -150px">
                <a href="/">
                    <img src="{{ asset('images/TreasuryLogo.webp') }}" style="height: 200px; width: auto;" alt="Treasury Logo">
                </a>
            </div>
