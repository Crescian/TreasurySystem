        ...
        <div class="max-w-8xl mx-auto">
            <div class="bg-white shadow-md rounded p-6 sm:p-8">
                <div class="flex justify-center items-center min-h-[100px] mt-6 spindiv">
                    ...
                    <div class="overflow-x-auto w-full flex justify-center items-center">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Date
                                    </th>
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Report
                                        Type
                                    </th>
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Bank
                                    </th>
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Account
                                        Name
                                    </th>
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">
                                        Cust/Vend/Emp</th>
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Invoice
                                    </th>
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Amount
                                    </th>
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Inflow
                                        Type
                                    </th>
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">
                                        Description</th>
                ...
                $.each(response, (key, value) => {
                    ...
                    tbody += `
                        <tr>
                            ...
                            <td class="px-4 py-2">${value.invoice}</td>
